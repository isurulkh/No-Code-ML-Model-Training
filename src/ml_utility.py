...
def preprocess_data(df, target_column, scaler_type):
    ...
    # Initialize scaler outside the if block
    scaler = None  # Placeholder value

    if len(numerical_cols) == 0:
        pass  # No numerical columns, skip scaling
    else:
...
def evaluate_model(model, X_test, y_test):
    ...
    # Specify average='micro' or another appropriate setting for multiclass
